...
public final class FoodRegistry {
    ...
    public static void register(@Nonnull ExoticGarden plugin, @Nonnull ItemGroup misc, @Nonnull ItemGroup drinks, @Nonnull ItemGroup food) {
        ...
        // Custom item
        new Juice(drinks, new SlimefunItemStack("ICE_COLA", new CustomPotion("&c冰可樂", Color.fromRGB(37, 30, 15), new PotionEffect(PotionEffectType.SPEED, 1200, 0), "", "&7+ 速度加成", "", "&7&o上面貼著&c&o可口可樂&7&o的字樣", "&7&o撕開後發現是&9&o百事", "&7&o這到底是什麼可樂呢...")), RecipeType.ENHANCED_CRAFTING_TABLE,
