...
public class Kitchen extends MultiBlockMachine {
    ...
    public Kitchen(ExoticGarden plugin, ItemGroup itemGroup) {
        super(itemGroup, new SlimefunItemStack("KITCHEN", Material.CAULDRON, "&e廚房", "", "&a&o你可以在此製作出各式各樣的美味!", "&a&o做好的成品可以在熔爐裡獲取"), new ItemStack[] { new CustomItemStack(Material.BRICK_STAIRS, "&o紅磚階梯 (顛倒)"), new CustomItemStack(Material.BRICK_STAIRS, "&o紅磚階梯 (顛倒)"), new ItemStack(Material.BRICKS), new ItemStack(Material.STONE_PRESSURE_PLATE), new ItemStack(Material.IRON_TRAPDOOR), new ItemStack(Material.BOOKSHELF), new ItemStack(Material.FURNACE), new ItemStack(Material.DISPENSER), new ItemStack(Material.CRAFTING_TABLE) }, new ItemStack[0], BlockFace.SELF);
